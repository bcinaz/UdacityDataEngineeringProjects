...
## I have got the error: time relation does nt exist and therefore I have change the order and put "songplay_table_create" at the bootom. Besides, I needed to delete REFERENCES to eliminate the error. Ressource: Udacity Knowledge
